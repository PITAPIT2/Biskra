...
export interface SeedPrice    { label: string; value: number; }
export interface SeedItem     { id: string; name: string; prices: SeedPrice[]; extra?: string; }
export interface SeedCategory { key: string; label: string; img?: string; extra?: string; items: SeedItem[]; }
export interface SeedJuice    { id:string;num:string;name:string;subtitle:string;color:string;shadow:string;bg:string;border:string;items:string[];price:number;oldPrice:number;img:string;blend:string; }

export const SEED_CATEGORIES: SeedCategory[] = [
  { key:"tacos-gratine", label:"TACOS GRATINÉ", extra:"Double Viande +150 DA", items:[
  ...
  { key:"tacos-classique", label:"TACOS CLASSIQUE", extra:"Double Viande +150 DA", items:[
  ...
  { key:"fajitas", label:"FAJITAS", items:[
  ...
  { key:"souffle", label:"SOUFFLÉE", items:[
  ...
  { key:"malfouf-makloub", label:"MALFOUF MAKLOUB", extra:"Double Viande +150 DA", items:[
  ...
  { key:"malfouf-tunisien", label:"MALFOUF TUNISIEN", extra:"Double Viande +150 DA", items:[
  ...
  { key:"pizza-boisee", label:"PIZZA BOISÉE", items:[
  ...
  { key:"pizza-maison", label:"PIZZA MAISON", extra:"Suppléments L:250 / XL:350 / XXL:500 DA", items:[
  ...
  { key:"shawarma-arabi", label:"SHAWARMA ARABI", items:[
